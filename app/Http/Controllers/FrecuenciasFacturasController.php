...
use App\Models\FrecuenciasFactura;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class FrecuenciasFacturasController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        // dd($clienteEstado);
        $cliente =  FrecuenciasFactura::where('estado', $frecuenciaEstado)->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            $frecuencia = FrecuenciasFactura::create([
    ...
    public function show($id, Request $request)
    {
        ...
        if (is_numeric($id)) {
            ...
            // dd($clienteEstado);
            $frecuencia =  FrecuenciasFactura::where([
                ['id', '=', $id],
    ...
    public function update(Request $request, $id)
    {
        ...
        if (is_numeric($id)) {
            $categoria =  FrecuenciasFactura::find($id);
    ...
    public function destroy($id)
    {
        ...
        if (is_numeric($id)) {
            $frecuencia =  FrecuenciasFactura::find($id);
