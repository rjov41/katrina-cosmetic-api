...
class ClienteController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validation = Validator::make($request->all(), [
            ...
            'nombreCompleto' => 'required|string|max:80|unique:clientes,celular',
            ...
            'telefono' => 'nullable|numeric|unique:clientes,telefono',
        ...
        if (is_numeric($id)) {
            ...
            if ($cliente) {
                $validation = Validator::make($request->all(), [
                    ...
                    'telefono' => 'nullable|numeric|unique:clientes,telefono,' . $id,
                    'direccion_casa' => 'required|string|max:180',
                    'direccion_negocio' => 'nullable|max:180',
