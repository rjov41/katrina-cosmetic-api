...
INSERT INTO `categorias` (`id`, `tipo`, `descripcion`, `estado`, `created_at`, `updated_at`) VALUES
	(1, 'A', '65 dias', 1, '2022-03-04 20:38:04', '2022-03-04 20:38:05'),
	(2, 'B', '45 dias', 1, '2022-03-04 20:38:04', '2022-03-04 20:38:05'),
	(3, 'C', '35 dias', 1, '2022-03-04 20:38:04', '2022-03-04 20:38:05');
...
INSERT INTO `clientes` (`id`, `categoria_id`, `frecuencia_id`, `user_id`, `nombreCompleto`, `nombreEmpresa`, `celular`, `telefono`, `direccion_casa`, `direccion_negocio`, `cedula`, `dias_cobro`, `estado`, `created_at`, `updated_at`) VALUES
	(1, 2, 1, 20, 'Cliente perfecto', 'Salon PR', 1131905210, 1131905212, 'Av.francisco beiro 3360', 'Av.francisco beiro 3360', '12142412221344', 'viernes,jueves,miércoles', 1, '2022-03-06 17:55:37', '2022-03-06 17:55:37');
...
-- Volcando datos para la tabla api_maquillaje.facturas: ~3 rows (aproximadamente)
...
INSERT INTO `facturas` (`id`, `user_id`, `cliente_id`, `monto`, `fecha_vencimiento`, `iva`, `tipo_venta`, `status_pagado`, `status`, `created_at`, `updated_at`) VALUES
	(1, 20, 1, 3310.00, '2022-05-07 12:00:00', 0.00, 1, 0, 1, '2022-03-06 17:55:53', '2022-03-06 17:55:53');
...
INSERT INTO `factura_detalles` (`id`, `producto_id`, `factura_id`, `cantidad`, `precio`, `estado`, `created_at`, `updated_at`) VALUES
	(1, 5, 1, 2, 310.00, 1, '2022-03-06 17:55:53', '2022-03-06 17:55:53'),
	(2, 6, 1, 1, 3000.00, 1, '2022-03-06 17:55:53', '2022-03-06 17:55:53');
...
INSERT INTO `productos` (`id`, `marca`, `modelo`, `stock`, `precio`, `linea`, `descripcion`, `estado`, `created_at`, `updated_at`) VALUES
	(5, 'Lizz Professional', '0000001', 8, 155.00, 'Planchas', 'Plancha Ultra 500', 1, '2022-03-03 19:54:15', '2022-03-06 17:55:53'),
	(6, 'test', 'test', 11, 3000.00, 'blanca', 'test nada mas', 1, '2022-03-04 03:06:00', '2022-03-06 17:55:53');
